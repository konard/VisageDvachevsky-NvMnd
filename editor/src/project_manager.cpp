...
Result<void> ProjectManager::restoreFromBackup(const std::string &backupPath) {
  ...
  return Result<void>::error("Backup restoration not yet implemented");
}
...
ProjectManager::createProjectFromTemplate(const std::string &templateName) {
  ...
  if (templateName == "kinetic_novel") {
    file << "// NovelMind Script - Kinetic Novel Template\n\n";
    file << "scene main {\n";
    file << "    background \"backgrounds/title.png\"\n";
    file << "    \n";
    file << "    \"Welcome to your kinetic novel!\"\n";
    file << "    \"This story will play linearly without choices.\"\n";
    file << "}\n";
    ...
    file << "    background \"backgrounds/title.png\"\n";
    file << "    \n";
    file << "    \"Welcome to your interactive story!\"\n";
    file << "    \n";
    file << "    choice {\n";
    file << "        \"Go left\" -> left_path\n";
    file << "        \"Go right\" -> right_path\n";
    file << "    }\n";
    file << "}\n\n";
    file << "scene left_path {\n";
    file << "    \"You chose the left path.\"\n";
    file << "}\n\n";
    file << "scene right_path {\n";
    file << "    \"You chose the right path.\"\n";
    file << "}\n";
  } else {
